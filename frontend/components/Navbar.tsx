  ...
  const SearchBar = ({ slim }: { slim?: boolean }) => (
    <div style={{ position: "relative", width: "100%" }}>
      <div style={{
        ...
        height: slim ? 40 : 44,
        border: `1.5px solid ${searchFocused ? "#6C63FF" : "#e0e0e0"}`,
        borderRadius: 10, backgroundColor: "#fff",
        boxShadow: searchFocused ? "0 0 0 2px #fff, 0 0 0 4px #6C63FF" : "none",
                ...
                <li key={link.label}>
                  <a
                    ...
                    style={{
                      ...
                      color: i === 0 ? "#6C63FF" : "#444",
                      backgroundColor: i === 0 ? "rgba(108,99,255,0.09)" : "transparent",
                      textDecoration: "none",
